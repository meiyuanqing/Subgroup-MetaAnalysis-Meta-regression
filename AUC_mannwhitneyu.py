...
Date : 2021/8/28
Time: 17:08
File: AUC_mannwhitneyu.py
HomePage : http://github.com/yuanqingmei
Email : dg1533019@smail.nju.edu.cn

Compute the value of AUC, by Wilcoxon rank sum method using mannwhitneyu() from scipy.stats.mannwhitneyu.

 the formula of U1 is different from U1 = n1 * n2 + n1*(n1+1)/2 - R1 , as I found on the
...
This test should be used to compare two samples from continuous distributions. It does not handle ties
between measurements in x and y. For tie-handling and an optional continuity correction see scipy.stats.mannwhitneyu.
...
def mannwhitneyu(x, y, use_continuity=True, alternative="two-sided",
    ...
    *p*-value produced using the normal approximation.
    ...
    #  20210828 U1 = n1 * n2 + n1*(n1+1)/2 - R1 , as I found on the
    # https://sphweb.bumc.bu.edu/otlt/MPH-Modules/BS/BS704_Nonparametric/BS704_Nonparametric4.html
...
if __name__ == '__main__':
    ...
    mannwhitneyu(males, females)
    e_time = time.time()
    execution_time = e_time - s_time
    print("The __name__ is ", __name__, ". This is end of AUC_mannwhitneyu.py!",
          "\nThe execution time of AUC_mannwhitneyu.py script is ", execution_time)
